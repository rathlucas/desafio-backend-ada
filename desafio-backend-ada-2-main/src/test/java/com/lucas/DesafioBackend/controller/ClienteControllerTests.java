...
public class ClienteControllerTests {
    ...
    @Test
    public void getClienteFromServiceQueue_shouldReturn404IfIsEmpty() throws Exception {

        when(clienteService.getClienteFromQueue()).thenReturn(null);
        mockMvc.perform(
                        MockMvcRequestBuilders
                                .get("/api/v1/clientes/fila-de-atendimento/retirar")
                                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    }

    @Test
    public void getClienteFromServiceQueue_shouldReturn200IfSuccesful() throws Exception {

        when(clienteService.getClienteFromQueue()).thenReturn(pessoaFisica);
        mockMvc.perform(
                        MockMvcRequestBuilders
                                .get("/api/v1/clientes/fila-de-atendimento/retirar")
                                .contentType(MediaType.APPLICATION_JSON))
